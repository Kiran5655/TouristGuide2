...
public class Basara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load("http://www.basaratemple.org/img/Galimgs/2.jpg").placeholder(R.drawable.appbg).into(gi1);
        gi2 = findViewById(R.id.gi2);
        Picasso.get().load("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3-JhV7PaaiwzJkY9mvNbEV4JiTtTw9oZLMw&usqp=CAU").placeholder(R.drawable.appbg).into(gi2);
